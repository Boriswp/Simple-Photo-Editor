package com.bescom.simplephotoeditorapp.repository

import android.content.Context
import android.graphics.Bitmap
import com.bescom.simplephotoeditorapp.imageEdit.ImageFilter
import jp.co.cyberagent.android.gpuimage.GPUImage
import jp.co.cyberagent.android.gpuimage.filter.*
import javax.inject.Inject

class ImageEditorRepository @Inject constructor() {

    fun loadImageFilters(image: Bitmap, context: Context): List<ImageFilter> {
        val gpuImage = GPUImage(context).apply {
            setImage(image)
        }

        return mapToImageFilters(gpuImage)
    }

    private fun mapToImageFilters(gpuImage: GPUImage): List<ImageFilter> {
